...
with open("../../../data/checklist/checklist_for_marketplaces.txt", "r") as f:
...
for documentation_file in filter(lambda x: x.endswith('.txt') or x.endswith('.md') or x.endswith('.html'), get_document_list('../../../data/platform_docs/marketplaces')):
